...
**Current build:** `0.14.11-rc45`
**Target game:** Intravenous 2 `1.4.12HF3`
**Status:** production-candidate test release. RC45 fixes the real selector's validate-then-render call sequence, preserves every native/third-party action ID, keeps takeover visually first and adds a restrained world marker to eligible bodies. Promotion to `1.0` remains gated by the documented crash-free live mission matrix.
