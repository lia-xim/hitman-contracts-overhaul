...
**Current build:** `0.10.0-rc15`
**Target game:** Intravenous 2 `1.4.12HF3`  
**Status:** public release candidate; boot and automated subsystem checks pass, while RC15's actor-pass drone rendering, geometric player detection, target evacuation, and split protection response require final in-game validation.
