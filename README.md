...
**Current build:** `0.14.12-rc46`
**Target game:** Intravenous 2 `1.4.12HF3`
**Status:** production-candidate test release. RC46 gives an eligible body native selection priority over its dropped weapon, self-heals independent render caches and restores critical hooks if another mod replaces them. Promotion to `1.0` remains gated by the documented crash-free live mission matrix.
