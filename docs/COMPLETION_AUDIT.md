...
| Target/protection presence | RC41 routine/incident watchdog pass | Target and guards observed; later AFK/local-incident gap reported | RC41 correction requires live pass |
| Multi-contract isolation | Pass | Not yet proven across a full live mission | Live test required |
| Disguise/social stealth | RC41 first-action takeover, explicit restore, persistent shimmer, three tiers, weapon-neutral distance cover, close scrutiny, point-blank exposure, radio and persistence pass | User reports the close-risk behavior works; new readability/rollback path is not yet live-tested | Partial live pass |
