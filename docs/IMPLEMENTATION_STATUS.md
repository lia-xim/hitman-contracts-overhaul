...
| Disguise and social stealth | RC37 candidate path: native identity switching plus weapon-neutral cover, observer-local hostility, clean identity rebinding and interception of vanilla instant-detect/combat branches | Full real-mission pass in `SPECIFICATION_TRACEABILITY.md` |
...
## RC22 roster / RC23–RC37 live corrections
...
1. Completely restart the game and confirm `0.14.3-rc37` loads without traceback and without an internal RC render diagnostic on the HUD.
