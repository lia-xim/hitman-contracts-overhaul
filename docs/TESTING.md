...
17. During routine, observe the protected target and all five close guards for at least 15 seconds. The target must follow its authored route and each close guard must move as part of the same protection chain. A nine-second stationary condition must advance the route without leaving the actor pathless.
