...
10. Target and all five bodyguards traverse at least five visibly distinct routine locations across several map sectors for 60 seconds; checkpoint reload must reconstruct the same route. Then verify first nearby loud-shot relocation without identity leak, shelter reselection after a local protection incident, evacuation and resolution, plus exactly-one payout after reload.
