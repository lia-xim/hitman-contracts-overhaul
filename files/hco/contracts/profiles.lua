...
profiles.list = {
	{
		...
		drone = {name="Watcher", count=2, speed=0.85, radius=1.2, detect=1.2, armor=1},
		escorts = 10,
		healthMultiplier = 2,
	...
	},
	{
		...
		drone = {name="Smuggler Eye", count=3, speed=1, radius=0.95, detect=1, armor=1},
		escorts = 5,
	...
	},
	{
		...
		drone = {name="Hunter Swarm", count=5, speed=1.2, radius=1.05, detect=0.72, armor=2},
		escorts = 20,
		healthMultiplier = 3,
	...
	},
	{
		...
		drone = {name="Interceptor", count=4, speed=1.35, radius=0.9, detect=0.78, armor=1},
		escorts = 15,
